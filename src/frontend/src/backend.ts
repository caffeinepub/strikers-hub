...
export class Backend implements backendInterface {
    ...
    async getAllStrikers(): Promise<Array<Striker>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStrikers();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getStrikerById(arg0: string): Promise<Striker> {
        if (this.processError) {
            try {
                const result = await this.actor.getStrikerById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopStrikers(arg0: bigint): Promise<Array<Striker>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopStrikers(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
